...
import { defaultProductAdProps, lineDurationSeconds, type ProductAdProps } from "./types";
...
function totalDurationInFrames(props: ProductAdProps): number {
  const totalSeconds = props.lines.reduce(
    (sum, line) => sum + lineDurationSeconds(line, props.secondsPerLine),
    0
  );
